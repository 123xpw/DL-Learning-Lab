...
| 年份 | 模型 | 核心贡献 |
|------|------|---------|
| 2025 | ODD-Net | 混合 CNN-Transformer 架构，兼顾局部纹理与全局上下文 |
| 2025 | Dehaze-Attention | 多尺度注意力框架，动态适配不同浓度雾的区域 |
| 2025 | Alpha-DehazeNet | 引入 RGBA 颜色空间，用透明度通道建模雾浓度 |
| 2025 | 夜间去雾方法 | 物理感知动态神经模型，专门处理夜间复杂大气条件 |

**核心挑战仍未解决**：合成雾数据训练的模型在真实场景泛化差，2025 年的研究重点已转向无配对真实数据训练和物理模型 + 深度学习的混合方案。
